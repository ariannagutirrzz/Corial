        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-display font-bold text-[#0F172A] mb-8 leading-tight">
              Pioneers of Boutique <br />Clinical Care.
            </h1>
            <p className="text-xl text-gray-600 font-sans leading-relaxed">
              Founded on the principles of excellence and refined aesthetics, Corial was established to fill a void in the Maracaibo healthcare landscape: a place where technical mastery meets high-end hospitality.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                We believe that healthcare should be a transformative journey. Our team of specialists is dedicated to not just treating symptoms, but enhancing the natural harmony of each patient's features and vitality.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  'Certified Specialist Team',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            <div id="stat-1-v9n2k4m1">
              ...
              <div className="text-[#F8FAFC]/60 font-sans uppercase tracking-widest text-xs">Years Experience</div>
            </div>
            <div id="stat-2-v9n2k4m1">
              <div className="text-5xl font-display font-bold text-[#C5A059] mb-2">2k+</div>
              <div className="text-[#F8FAFC]/60 font-sans uppercase tracking-widest text-xs">Smiles Refined</div>
            </div>
            <div id="stat-3-v9n2k4m1">
              <div className="text-5xl font-display font-bold text-[#C5A059] mb-2">12+</div>
              <div className="text-[#F8FAFC]/60 font-sans uppercase tracking-widest text-xs">Specialists</div>
            </div>
            <div id="stat-4-v9n2k4m1">
              <div className="text-5xl font-display font-bold text-[#C5A059] mb-2">100%</div>
              <div className="text-[#F8FAFC]/60 font-sans uppercase tracking-widest text-xs">Commitment</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p className="text-2xl font-display text-[#0F172A]/80 leading-relaxed italic">
              "Excellence is not an act, but a habit. In our clinic, excellence is woven into every consultation, every procedure, and every outcome. We don't just treat; we elevate."
            </p>
          </div>
        </div>
      </section>
